...
__webpack_require__(/*! ./prevImg */ "./resources/js/prevImg.js"); // Import all plugins
...
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; // window.alpinejs = require('alpinejs');
